    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="content navy">
          <div class="columns">
            <div class="column">The programme aims to create effective awareness in various levels (of society) to reduce the adverse impact on environment and health arising out of the polluting technologies used in recycling e-waste in the unorganized sector.</div>
            <div class="column">The charter for this programme is to bring together the triad of public, government and industry to adopt responsible measures for Sustainable electronics that is responsive to environmental needs. This needs proactive policy formation and mass deployment that would be the focus area.</div>
            <div class="column">A one-stop solution that enables Corporates, industries, and Institutions or anyone who has an inventory of waste to sell, and for recyclers of waste to buy it seamlessly through the E Waste Social auction platform.</div>
          </div>
